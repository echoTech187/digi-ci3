...
class EwalletDynamic extends CI_Model
{
    ...
    public function getDataEwalletDynamicChannelExternal($ref_cashinExternalId, $ref_cashinExternalLogEwalletIdCreate) {
        ...
        if ($ref_cashinExternalId == 'ifp') {
            ...
            if (!$result1_1) {
                $qtxt1_fallback = "SELECT c_orderId, c_transactionId, c_datetimeRequest, c_requestHeader, c_requestBody, c_datetimeResponse, c_responseHeader, c_responseBody FROM external_ifp_ewallet_create ORDER BY id DESC LIMIT 1";
        ...
        if ($RequestBody === null && $ResponseHeader === null) {
            $tables_to_check = [
                ['table' => 'external_ifp_ewallet_create', 'field1' => 'c_orderId', 'field2' => 'c_transactionId'],
                ['table' => 'external_gvpay_ewallet_create', 'field1' => 'c_customId', 'field2' => 'c_customId'],
            ];
