...
class QRISDynamic extends CI_Model
{
    ...
    public function getDataQrisDynamicChannelExternal($ref_cashinExternalId, $ref_cashinExternalLogQrisMpmIdCreate, $parentId = null) {
        ...
        if ($RequestBody === null && $ResponseHeader === null) {
            $tables_to_check = [
                ['table' => 'external_paylabs_qris_mpm_create', 'field1' => 'c_platformTradeNo', 'field2' => 'c_merchantTradeNo'],
                ['table' => 'external_ifp_qris_mpm_create', 'field1' => 'c_orderId', 'field2' => 'c_transactionId'],
                ['table' => 'external_quantum_qris_mpm_create', 'field1' => 'c_transactionId', 'field2' => 'c_quantumSubMerchantId'],
                ['table' => 'external_inacash_qris_mpm_create', 'field1' => 'refId', 'field2' => 'partnerRefId'],
                ['table' => 'external_paydgn_qris_mpm_create', 'field1' => 'refId', 'field2' => 'partnerRefId'],
                ['table' => 'external_paylabs2_qris_mpm_create', 'field1' => 'c_platformTradeNo', 'field2' => 'c_merchantTradeNo'],
            ];
