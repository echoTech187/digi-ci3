                ...
                return `
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg">
                            ...
                            <li><a class="dropdown-item text-danger" href="<?= base_url('admin/cashin/external/delete') ?>/${row.id}" onclick="return confirm('Delete this configuration?')"><i class="fas fa-trash mr-2"></i> Delete</a></li>
                        </ul>
                    </div>
                `;
            }
