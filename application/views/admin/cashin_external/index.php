<div>
    ...
    <div class="dt-page-header">
        ...
        <div class="d-flex" style="gap:10px;">
            ...
            <a href="<?= base_url('admin/cashin/external/add_view'); ?>" class="btn-dt-action btn-dt-action-success border-0 text-decoration-none d-flex align-items-center">
                ...
                return `
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right border-0 shadow-lg">
                            <li><a class="dropdown-item" href="<?= base_url('admin/cashin/external/edit_view') ?>/${row.id}"><i class="fas fa-edit text-primary mr-2"></i> Edit</a></li>
