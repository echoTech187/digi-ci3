<div>
    ...
    <div class="dt-page-header">
        <div>
            ...
            <p class="dt-page-subtitle">Configure external payment channel mappings for merchants (Cashout)</p>
        </div>
    </div>
                    ...
                    <form action="<?= base_url('external/cashout/add'); ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <select name="ref_cashoutChannelId" id="ref_cashoutChannelId" class="form-control select2" disabled required>
            ...
            <div class="card border-0 shadow-sm mb-4 bg-gradient-primary text-white" style="border-radius: 12px; overflow: hidden;">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h5 class="font-weight-bold mb-0">Cashout Mapping</h5>
                    </div>
    ...
    $(document).ready(function() {
        $('#c_cashoutChannelGroup').on('change', function() {
            ...
            if (!group) {
                ...
                $('#ref_cashoutChannelId').val('').prop('disabled', true).trigger('change.select2');
                return;
            }
        ...
        function fetchOptions(group, external_id, updateProvider) {
            ...
            if (updateProvider) {
                ...
                $('#ref_cashoutChannelId').prop('disabled', true).html('<option value="">Select channel ID</option>').trigger('change.select2');
            } else {
