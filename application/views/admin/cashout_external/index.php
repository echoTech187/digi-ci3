    ...
    <div class="card border-0 shadow-sm dt-card">
        ...
        <div class="dt-toolbar">
            <div class="dt-search-wrapper flex-grow-1 mb-2 mb-md-0" style="min-width: 280px;">
                ...
                <input type="text" id="dt-search" class="dt-search-input" placeholder="Search merchant or channel..." value="<?= htmlspecialchars($this->session->userdata('search_external_cashout')); ?>">
            </div>
                ...
                <div class="dt-filter-group dt-more-filters-wrapper">
                    ...
                    <div class="dt-more-panel" id="cashoutMoreFiltersPanel">
                        ...
                        <div class="dt-more-panel-footer">
                            <button type="button" class="btn-dt-action btn-dt-action-primary w-100" id="cashoutMoreApply">Apply Filters</button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $this->load->view('admin/cashout_external/partials/modal_global_update'); ?>

<!-- ── Include JavaScript Assets ── -->
<script src="<?= base_url('assets/js/external_mapping_helper.js'); ?>"></script>
<script src="<?= base_url('assets/js/cashout_external.js'); ?>"></script>
