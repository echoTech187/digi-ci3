...
<head>
	...
	<style>
		body {
			...
			background-color: #f8f9fc; /* SB Admin 2 light gray background */
			margin: 0;
		}
	</style>
</head>
...
<body>
	...
	<!-- Logout Modal-->
	<div class="modal fade" data-backdrop="static" data-keyboard="false" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
