...
<div>
 ...
 <button type="button" class="btn-dt-action btn-dt-action-success border-0 text-decoration-none d-flex align-items-center" data-toggle="modal" data-target="." >
...
<!-- ── Modal Tambah Chanel ── -->
<div class="modal fade " id="addChanelModal" tabindex="-1" role="dialog" aria-labelledby="addChanelModalLabel" aria-hidden="true">
...
<!-- ── Modal Edit Chanel ── -->
<div class="modal fade " id="editChanelModal" tabindex="-1" role="dialog" aria-labelledby="editChanelModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-dialog-centered">
 <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
 <div class="modal-header modal-header-primary border-0 mh-premium">
 <div class="d-flex align-items-center">
