<div id="module-api-cashin" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="mb-5">
            ...
            <!-- Auth steps -->
            <div class="pl-4 border-left border-warning ml-2 mt-4">
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-qrcode text-info mr-2"></i> 2. QRIS Endpoints</h5>
...
&nbsp;&nbsp;}<br>
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-exclamation-triangle text-danger mr-2"></i> 3. Common Error Codes</h5>
        ...
        <!-- FAQ -->
        <h5 class="font-weight-bold mb-4 mt-5 d-flex align-items-center"><i class="fas fa-question-circle text-warning mr-3"></i> Common Integration Questions</h5>
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_cashin_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Q: I keep getting INVALID_SIGNATURE even though I'm using the correct key
                </a>
                <div id="faq_en_cashin_1" class="collapse">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_cashin_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Q: How do I know if a payment has been completed (webhook / callback)?
                </a>
                <div id="faq_en_cashin_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_cashin_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Q: What happens if my customer pays after the QRIS has expired?
                </a>
                <div id="faq_en_cashin_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <!-- Section 2: QRIS Endpoints -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-qrcode text-info mr-2"></i> 2. Endpoint QRIS</h5>
...
&nbsp;&nbsp;}<br>
        ...
        <!-- Section 3: Error Codes -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-exclamation-triangle text-danger mr-2"></i> 3. Kode Error Umum</h5>
            <div class="table-responsive shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                    <thead style="background: rgba(0,0,0,0.4);">
                        <tr>
        ...
        <!-- FAQ -->
        <h5 class="font-weight-bold mb-4 mt-5 d-flex align-items-center"><i class="fas fa-question-circle text-warning mr-3"></i> Pertanyaan Integrasi Umum (FAQ)</h5>
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_cashin_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> T: Terus mendapat INVALID_SIGNATURE meski sudah menggunakan key yang benar
                </a>
                <div id="faq_id_cashin_1" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_cashin_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> T: Bagaimana cara mengetahui pembayaran sudah selesai (callback/webhook)?
                </a>
                <div id="faq_id_cashin_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_cashin_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> T: Apa yang terjadi jika pelanggan membayar setelah QRIS kadaluarsa?
                </a>
                <div id="faq_id_cashin_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
