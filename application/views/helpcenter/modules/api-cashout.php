<div id="module-api-cashout" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <!-- Section 1: Auth -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-lock text-warning mr-2"></i> 1. Authentication & Security</h5>
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-search-dollar text-info mr-2"></i> 2. Account Inquiry (Recommended Before Transfer)</h5>
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-paper-plane text-success mr-2"></i> 3. BI-Fast Transfer Execution</h5>
...
&nbsp;&nbsp;}<br>
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-exclamation-triangle text-danger mr-2"></i> 4. Common Error Codes</h5>
        ...
        <!-- FAQ -->
        <h5 class="font-weight-bold mb-4 mt-5 d-flex align-items-center"><i class="fas fa-question-circle text-warning mr-3"></i> Common Disbursement Questions</h5>
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_cashout_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Q: The transfer response is SUCCESS but the beneficiary hasn't received the money
                </a>
                <div id="faq_en_cashout_1" class="collapse">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_cashout_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Q: What is the difference between methodFee "Merchant" and "Destination"?
                </a>
                <div id="faq_en_cashout_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_cashout_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Q: Can I cancel or reverse a transfer that is already PROCESSING?
                </a>
                <div id="faq_en_cashout_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <!-- Section 1: Auth -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-lock text-warning mr-2"></i> 1. Autentikasi & Keamanan</h5>
        ...
        <!-- Section 2: Account Inquiry -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-search-dollar text-info mr-2"></i> 2. Inquiry Rekening (Sangat Direkomendasikan Sebelum Transfer)</h5>
        ...
        <!-- Section 3: BI-Fast Transfer -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-paper-plane text-success mr-2"></i> 3. Eksekusi Transfer BI-Fast</h5>
...
&nbsp;&nbsp;}<br>
        ...
        <!-- Section 4: Error Codes -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-exclamation-triangle text-danger mr-2"></i> 4. Kode Error Umum</h5>
            <div class="table-responsive shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                    <thead style="background: rgba(0,0,0,0.4);">
                        <tr>
        ...
        <!-- FAQ -->
        <h5 class="font-weight-bold mb-4 mt-5 d-flex align-items-center"><i class="fas fa-question-circle text-warning mr-3"></i> Pertanyaan Disbursement Umum (FAQ)</h5>
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_cashout_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> T: Response transfer SUCCESS tapi penerima belum terima uangnya
                </a>
                <div id="faq_id_cashout_1" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_cashout_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> T: Apa perbedaan methodFee "Merchant" dan "Destination"?
                </a>
                <div id="faq_id_cashout_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_cashout_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> T: Apakah transfer yang sudah PROCESSING bisa dibatalkan?
                </a>
                <div id="faq_id_cashout_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
