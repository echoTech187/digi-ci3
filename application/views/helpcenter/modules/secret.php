<div id="module-secret" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                ...
                <h3 class="hc-step-title">Security Architecture (Zero-Persistence Model)</h3>
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                ...
                <h3 class="hc-step-title">Generating a Secret Key</h3>
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                ...
                <h3 class="hc-step-title">Revoking or Regenerating a Key</h3>
        ...
        <!-- FAQ -->
        <h4 class="font-weight-bold mb-4 mt-5 border-bottom pb-2">Common Issues & What To Do</h4>
        
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Issue 1: The merchant says the key doesn't work (INVALID_CREDENTIAL)</span>
            </div>
            <div class="hc-faq-a">
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Issue 2: I closed the page before copying the key</span>
            </div>
            <div class="hc-faq-a">
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Issue 3: The "Generate Key" button is grayed out / not clickable</span>
            </div>
            <div class="hc-faq-a">
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                <div class="hc-step-number">1</div>
                <h3 class="hc-step-title">Arsitektur Keamanan (Model Zero-Persistence)</h3>
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                <div class="hc-step-number">2</div>
                <h3 class="hc-step-title">Membuat Secret Key</h3>
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                <div class="hc-step-number">3</div>
                <h3 class="hc-step-title">Mencabut atau Membuat Ulang Key</h3>
        ...
        <!-- FAQ -->
        <h4 class="font-weight-bold mb-4 mt-5 border-bottom pb-2">Panduan Pemecahan Masalah (FAQ)</h4>
        
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 1: Merchant bilang key tidak berfungsi (INVALID_CREDENTIAL)</span>
            </div>
            <div class="hc-faq-a">
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 2: Saya menutup halaman sebelum menyalin key</span>
            </div>
            <div class="hc-faq-a">
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 3: Tombol "Generate Key" abu-abu / tidak bisa diklik</span>
            </div>
            <div class="hc-faq-a">
