<div id="module-ug-balance-logs" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <!-- Section 1: Auditing Workflow -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-book text-primary mr-2"></i> 1. Auditing the Ledger — Step-by-Step</h5>
        ...
        <!-- Section 2: Mutation Types -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-tags text-primary mr-2"></i> 2. Understanding Mutation Types</h5>
            <div class="table-responsive shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                    <thead style="background: rgba(0,0,0,0.4);">
                        <tr>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_bl_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 1: Can mutations be edited or deleted?
                </a>
                <div id="faq_en_bl_1" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Answer:</strong> Absolutely not. The mutation log is an immutable ledger. No admin — including Super Admins — can edit or delete existing records. All corrections must be done by adding a new <strong>reversal mutation</strong> (e.g., a Credit to cancel a wrong Debit) to ensure a complete, tamper-proof audit trail. Contact your system administrator to request a manual adjustment.
                    </div>
                </div>
            </div>
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_bl_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 2: What does a "Hold" mutation mean?
                </a>
                <div id="faq_en_bl_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Answer:</strong> When a merchant initiates a Cashout, the funds are immediately moved from <em>Available Balance</em> to <em>Hold</em>. This appears as a <code>cashout_hold</code> Debit mutation. Once the bank transfer succeeds and is confirmed, a second <code>cashout_release</code> Debit mutation removes the held funds permanently. If the transfer fails, a corresponding Credit mutation returns the funds to Available.
                    </div>
                </div>
            </div>
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_bl_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 3: Why is there a Debit without a corresponding withdrawal request?
                </a>
                <div id="faq_en_bl_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Answer:</strong> This is typically an automatic <strong>admin fee</strong> or <strong>MDR deduction</strong>. If the merchant is set to gross-settlement mode, fees are batched and charged automatically at the end of the settlement period rather than deducted per-transaction. Check the Description column for <code>fee_deduction</code> or <code>mdr_batch</code> labels to confirm.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <!-- Section 1: Auditing Workflow -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-book text-primary mr-2"></i> 1. Mengaudit Buku Besar — Langkah-demi-Langkah</h5>
        ...
        <!-- Section 2: Mutation Types -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-tags text-primary mr-2"></i> 2. Memahami Tipe Mutasi</h5>
            <div class="table-responsive shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                    <thead style="background: rgba(0,0,0,0.4);">
                        <tr>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_bl_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 1: Bisakah mutasi diedit atau dihapus?
                </a>
                <div id="faq_id_bl_1" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Jawaban:</strong> Sama sekali tidak. Log mutasi adalah buku besar yang tidak dapat diubah (immutable). Tidak ada admin — termasuk Super Admin — yang dapat mengedit atau menghapus record yang sudah ada. Semua koreksi harus dilakukan dengan menambahkan <strong>mutasi pembalikan</strong> baru (mis. Credit untuk membatalkan Debit yang salah) guna memastikan jejak audit yang lengkap dan anti-manipulasi. Hubungi administrator sistem Anda untuk meminta penyesuaian manual.
                    </div>
                </div>
            </div>
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_bl_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 2: Apa arti mutasi "Hold"?
                </a>
                <div id="faq_id_bl_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Jawaban:</strong> Saat merchant memulai Cashout, dana segera dipindahkan dari <em>Saldo Tersedia</em> ke <em>Hold</em>. Ini muncul sebagai mutasi Debit <code>cashout_hold</code>. Setelah transfer bank dikonfirmasi berhasil, mutasi Debit kedua <code>cashout_release</code> menghapus dana yang ditahan secara permanen. Jika transfer gagal, mutasi Credit yang sesuai mengembalikan dana ke Saldo Tersedia.
                    </div>
                </div>
            </div>
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_bl_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 3: Mengapa ada Debit tanpa permintaan penarikan dana?
                </a>
                <div id="faq_id_bl_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Jawaban:</strong> Ini biasanya adalah <strong>biaya admin</strong> atau <strong>pemotongan MDR</strong> otomatis. Jika merchant diatur ke mode gross-settlement, biaya di-batch dan ditagih secara otomatis di akhir periode settlement, bukan dipotong per-transaksi. Periksa kolom Description untuk label <code>fee_deduction</code> atau <code>mdr_batch</code> untuk memastikannya.
                    </div>
                </div>
            </div>
        </div>
