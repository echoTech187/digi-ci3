<div id="module-ug-ewallet-dynamic" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="mb-5">
            ...
            <div class="pl-4 border-left border-primary ml-2 mb-4">
                <ol class="text-muted mb-0">
                    <li class="mb-3"><strong>Quick Search:</strong> Type in the <em>Search Transaction, Merchant, or ID...</em> box to instantly filter the table. If a customer provides a screenshot of a failed OVO payment, type their Invoice ID here.</li>
                    ...
                    <li class="mb-3">Filter your parameters: <strong>Period</strong>, <strong>Merchant</strong>, <strong>External Channel</strong>, <strong>Channel ID</strong> (e.g., DANA), or <strong>Status Transaction</strong>.</li>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_ewd_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 1: Why did the OVO push-to-pay notification fail to appear?
                </a>
                <div id="faq_en_ewd_1" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Answer:</strong> Push notifications depend on the customer's phone connectivity, battery optimization settings, and OVO app permissions. If the notification fails to pop up, the merchant should instruct the customer to open the OVO app directly and check their "Notifications/Inbox" tab to approve the payment.
                    </div>
                </div>
            </div>
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_ewd_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 2: What is the difference between Push-to-Pay and Redirect?
                </a>
                <div id="faq_en_ewd_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Answer:</strong> Push-to-Pay sends a prompt directly to the customer's phone number (requires the phone number input during checkout). Redirect requires the customer to click a link on the merchant's site that opens the e-wallet app via a deep-link (no phone number required upfront).
                    </div>
                </div>
            </div>
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_ewd_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 3: Are e-wallet refunds supported?
                </a>
                <div id="faq_en_ewd_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Answer:</strong> Yes, partial and full refunds are generally supported for e-wallet transactions (unlike VA). The merchant can trigger a refund via the API, which will credit the balance back to the user's e-wallet app.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <div class="mb-5">
            ...
            <div class="pl-4 border-left border-primary ml-2 mb-4">
                <ol class="text-muted mb-0">
                    <li class="mb-3"><strong>Pencarian Cepat:</strong> Ketik di kotak <em>Search Transaction, Merchant, or ID...</em> untuk memfilter tabel secara instan. Jika pelanggan mengirim bukti error, salin-tempel Invoice ID mereka di sini.</li>
                    ...
                    <li class="mb-3">Saring parameter: <strong>Period</strong>, <strong>Merchant</strong>, <strong>External Channel</strong>, <strong>Channel ID</strong> (mis. DANA), atau <strong>Status Transaction</strong>.</li>
                    <li class="mb-2">Klik <strong>APPLY FILTER</strong> untuk memuat data. Klik <strong>Clear All</strong> untuk reset tampilan.</li>
                </ol>
            </div>
        </div>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_ewd_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 1: Kenapa notifikasi push-to-pay OVO tidak muncul?
                </a>
                <div id="faq_id_ewd_1" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Jawaban:</strong> Notifikasi push sangat bergantung pada kualitas sinyal internet, setelan penghemat baterai ponsel, dan izin notifikasi aplikasi OVO pelanggan. Jika gagal muncul, merchant wajib menyuruh nasabah membuka aplikasi OVO secara manual lalu cek tab "Kotak Masuk / Notifikasi" untuk menyetujui pembayaran.
                    </div>
                </div>
            </div>
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_ewd_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 2: Apa bedanya metode Push-to-Pay dan Redirect?
                </a>
                <div id="faq_id_ewd_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Jawaban:</strong> Push-to-Pay mengirimkan prompt persetujuan langsung ke nomor HP yang diinput (wajib input nomor saat checkout). Sedangkan Redirect mengharuskan nasabah mengklik tombol "Bayar" di website yang akan otomatis membuka aplikasi e-wallet via <em>deep-link</em> (tidak perlu input nomor HP di awal).
                    </div>
                </div>
            </div>
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_ewd_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 3: Apakah transaksi e-wallet bisa di-refund?
                </a>
                <div id="faq_id_ewd_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Jawaban:</strong> Ya, tidak seperti VA, refund parsial dan penuh umumnya didukung oleh channel e-wallet. Merchant dapat memicu proses refund melalui pemanggilan API, dan dana akan dikembalikan langsung ke saldo e-wallet pengguna.
                    </div>
                </div>
            </div>
        </div>
