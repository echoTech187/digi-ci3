<div id="module-ug-external-cashout" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <p class="doc-lead text-muted" style="line-height: 1.7;">The <strong>External Cash-Out</strong> module allows administrators to map a Merchant to a specific External Payment Provider (Aggregator/Acquirer) for outbound transactions (Disbursements, BI-FAST). You can configure specific fees and transfer limits per channel.</p>
                        
        <hr class="my-4">

        <!-- UI Overview Table -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-th-list text-primary mr-2"></i> UI Overview — Cash-Out Mapping Directory</h5>
            <div class="table-responsive shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                    ...
                    <tbody>
                        <tr><td class="p-3 border-0"><strong>Merchant</strong></td><td class="p-3 border-0">The target Active merchant mapped to the outbound channel.</td></tr>
                        <tr><td class="p-3 border-0"><strong>Channel Config</strong></td><td class="p-3 border-0">Displays the Channel Group (e.g. Transfer, BI-FAST), Channel ID, and the Provider (External ID Default).</td></tr>
                        <tr><td class="p-3 border-0"><strong>Fee Details</strong></td><td class="p-3 border-0">The Fee Type (Flat/Percentage), Fixed Fee amount, and Percentage Fee applied per disbursement.</td></tr>
                        <tr><td class="p-3 border-0"><strong>Limits</strong></td><td class="p-3 border-0">The minimum and maximum transfer amounts allowed for this specific mapping.</td></tr>
                        <tr><td class="p-3 border-0"><strong>Status</strong></td><td class="p-3 border-0">Active or Not Active mapping status.</td></tr>
        ...
        <div class="mb-5">
            ...
            <div class="pl-4 border-left border-primary ml-2 mb-4">
                <ol class="text-muted mb-0">
                    ...
                    <li class="mb-3">Configure your parameters: <strong>Merchant</strong>, <strong>Channel Group</strong>, <strong>Provider</strong>, <strong>Channel ID</strong>, atau <strong>Status</strong>.</li>
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-project-diagram text-primary mr-2"></i> 1. Architecture: Cash-Out Routing</h5>
            <p class="text-muted mb-4">The Cash-Out mapping engine routes outbound fund transfers (Disbursements) from the Merchant through the Gateway to specific aggregators or direct bank APIs.</p>

            <div class="mb-5 p-4" style="background: var(--hc-sidebar-bg); border-radius: 12px; border: 1px solid var(--hc-border);">
                <h6 class="font-weight-bold mb-3" style="color: var(--hc-heading);">Outbound Payment Routing Flow</h6>
                <div class="mermaid">
                flowchart TD
                    M((Merchant)) -->|Request Disbursement| G[Gateway]
                    
                    G -->|Lookup Mapping| MT[Cash-Out Mapping Table]
                    
                    MT -.->|Provider A| PA[Paylabs]
                    MT -.->|Provider B| PB[Faspay]
                    MT -.->|Provider C| PC[Direct Bank]
                    
                    PA -->|Transfers| EU[(End User Bank Account)]
                    PB -->|Transfers| EU
                    PC -->|Transfers| EU
                    
                    style M fill:#2563eb,stroke:#1d4ed8,stroke-width:2px,color:#fff
                    style EU fill:#16a34a,stroke:#15803d,stroke-width:2px,color:#fff
                </div>
            </div>

            <div class="pl-4 border-left border-primary ml-2 mb-4">
                <ol class="text-muted mb-0">
                    <li class="mb-3"><strong>Entity Mapping:</strong> When a merchant requests a disbursement, the Gateway checks the Cash-Out Mapping table for the Merchant ID and Channel ID.</li>
                    <li class="mb-3"><strong>Aggregator Forwarding:</strong> The gateway uses the <code>External Default</code> to forward the transfer request to the correct aggregator API.</li>
                    <li class="mb-2"><strong>Fee Calculation:</strong> The configured Cash-out Fee is deducted from the merchant's master balance along with the transfer principal.</li>
                </ol>
            </div>
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-edit text-success mr-2"></i> 2. Operating the Cash-Out Mappings</h5>
            <p class="text-muted mb-4">How to manage outbound channels and perform mass migrations.</p>

            <h6 class="font-weight-bold mb-3 mt-4 text-dark"><i class="fas fa-chevron-circle-right text-success mr-2"></i> Workflow A: Adding a New Cash-Out Mapping</h6>
            <div class="pl-4 border-left border-success ml-2 mb-4">
                <ol class="text-muted mb-0">
                    ...
                    <li class="mb-3">Fill in the Fee rules and nominal Min/Max transfer limits.</li>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_extco_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                ...
                <div id="faq_en_extco_1" class="collapse">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_extco_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 2: The external provider dropdown is empty
                </a>
                <div id="faq_en_extco_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <p class="doc-lead text-muted" style="line-height: 1.7;">Modul <strong>External Cash-Out</strong> memungkinkan administrator untuk memetakan Merchant ke Penyedia Pembayaran Eksternal (Aggregator/Acquirer) tertentu untuk transaksi keluar (Disbursement, BI-FAST). Anda dapat mengonfigurasi biaya (fee) dan limit transfer secara spesifik per channel.</p>
                        
        <hr class="my-4">

        <!-- UI Overview Table -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-th-list text-primary mr-2"></i> Ikhtisar UI — Direktori Mapping Cash-Out</h5>
            <div class="table-responsive shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                    <thead style="background: rgba(0,0,0,0.4);">
                        <tr>
                    ...
                    <tbody>
                        <tr><td class="p-3 border-0"><strong>Merchant</strong></td><td class="p-3 border-0">Merchant Aktif yang dipetakan ke channel pengeluaran ini.</td></tr>
                        <tr><td class="p-3 border-0"><strong>Channel Config</strong></td><td class="p-3 border-0">Menampilkan Channel Group (mis. Transfer, BI-FAST), Channel ID, dan Provider tujuan (External ID).</td></tr>
                        <tr><td class="p-3 border-0"><strong>Fee Details</strong></td><td class="p-3 border-0">Tipe Biaya (Flat/Persentase), nominal Fixed Fee, dan Persentase Fee per transaksi keluar.</td></tr>
                        <tr><td class="p-3 border-0"><strong>Limits</strong></td><td class="p-3 border-0">Batas minimum dan maksimum nominal transfer yang diizinkan untuk pemetaan ini.</td></tr>
                        <tr><td class="p-3 border-0"><strong>Status</strong></td><td class="p-3 border-0">Status pemetaan (Active atau Not Active).</td></tr>
        ...
        <!-- Section 1: Architecture -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-project-diagram text-primary mr-2"></i> 1. Arsitektur: Perutean Cash-Out</h5>
            <p class="text-muted mb-4">Mesin pemetaan Cash-Out mengarahkan transfer dana keluar (Disbursement) dari Merchant melalui Gateway ke API aggregator atau bank tujuan secara langsung.</p>

            <div class="mb-5 p-4" style="background: var(--hc-sidebar-bg); border-radius: 12px; border: 1px solid var(--hc-border);">
                <h6 class="font-weight-bold mb-3" style="color: var(--hc-heading);">Alur Perutean Pembayaran Keluar</h6>
                <div class="mermaid">
                flowchart TD
                    M((Merchant)) -->|Request Disbursement| G[Gateway]
                    
                    G -->|Cek Mapping| MT[Tabel Mapping Cash-Out]
                    
                    MT -.->|Provider A| PA[Paylabs]
                    MT -.->|Provider B| PB[Faspay]
                    MT -.->|Provider C| PC[Direct Bank]
                    
                    PA -->|Transfer| EU[(Rekening Tujuan)]
                    PB -->|Transfer| EU
                    PC -->|Transfer| EU
            ...
            <div class="pl-4 border-left border-primary ml-2 mb-4">
                <ol class="text-muted mb-0">
                    <li class="mb-3"><strong>Pemetaan Entitas:</strong> Saat merchant me-request disbursement, Gateway memeriksa tabel Cash-Out Mapping untuk ID Merchant dan ID Channel.</li>
                    <li class="mb-3"><strong>Meneruskan ke Aggregator:</strong> Gateway menggunakan nilai <code>External Default</code> untuk meneruskan perintah transfer ke API aggregator yang tepat.</li>
                    <li class="mb-2"><strong>Kalkulasi Biaya:</strong> Fee disbursement yang dikonfigurasi akan dipotong dari Master Balance merchant bersamaan dengan pokok transfer.</li>
                </ol>
            </div>
            ...
            <div class="doc-callout callout-warning shadow-sm mt-4">
                ...
                <div class="callout-content">
                    ...
                    <p class="mb-0 text-muted small">Merchant hanya boleh memiliki SATU mapping cash-out aktif per Channel ID. Jika Anda mencoba menambahkan channel yang sudah ada untuk merchant tersebut, sistem akan menolaknya dengan peringatan duplikat.</p>
                </div>
            </div>
        </div>
        ...
        <!-- Section 2: Step-by-Step -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-edit text-success mr-2"></i> 2. Mengoperasikan Mapping Cash-Out</h5>
            <p class="text-muted mb-4">Cara mengelola channel pengeluaran dan melakukan migrasi massal.</p>

            <h6 class="font-weight-bold mb-3 mt-4 text-dark"><i class="fas fa-chevron-circle-right text-success mr-2"></i> Alur Kerja A: Menambahkan Mapping Cash-Out Baru</h6>
            <div class="pl-4 border-left border-success ml-2 mb-4">
                <ol class="text-muted mb-0">
                    ...
                    <li class="mb-3">Isi aturan Fee dan nominal Min/Max limit transfer.</li>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_extco_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                ...
                <div id="faq_id_extco_1" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_extco_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 2: Dropdown pilihan Provider kosong
                </a>
                <div id="faq_id_extco_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
