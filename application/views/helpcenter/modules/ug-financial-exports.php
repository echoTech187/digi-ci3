<div id="module-ug-financial-exports" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-project-diagram text-primary mr-2"></i> 1. Architecture: Asynchronous Data Pipeline</h5>
        ...
        <!-- Section 2: Download Steps -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-file-export text-primary mr-2"></i> 2. Downloading Reports — Step-by-Step</h5>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_fe_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 1: Report status is FAILED — what should I do?
                </a>
                <div id="faq_en_fe_1" class="collapse">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_fe_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 2: Report is still PENDING after 10+ minutes
                </a>
                <div id="faq_en_fe_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_en_fe_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 3: Can I download a report generated by another administrator?
                </a>
                <div id="faq_en_fe_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Answer:</strong> Yes. The Financial Exports page acts as a <strong>shared hub</strong> for all administrators who have the appropriate RBAC access to this module. All reports — regardless of who triggered them — are visible and downloadable by any authorized admin. The <strong>REQUESTED BY</strong> column shows who originally generated each report.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <!-- Section 1: Architecture -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-project-diagram text-primary mr-2"></i> 1. Arsitektur: Pipeline Data Asinkron</h5>
        ...
        <!-- Section 2: Download Steps -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-file-export text-primary mr-2"></i> 2. Mengunduh Laporan — Langkah-demi-Langkah</h5>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_fe_1" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 1: Status laporan adalah FAILED — apa yang harus dilakukan?
                </a>
                <div id="faq_id_fe_1" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_fe_2" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 2: Laporan masih PENDING setelah 10+ menit
                </a>
                <div id="faq_id_fe_2" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#faq_id_fe_3" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 3: Bisakah saya mengunduh laporan yang di-generate oleh admin lain?
                </a>
                <div id="faq_id_fe_3" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
                        <strong>Jawaban:</strong> Ya. Halaman Ekspor Keuangan berfungsi sebagai <strong>hub bersama</strong> untuk semua administrator yang memiliki akses RBAC yang sesuai untuk modul ini. Semua laporan — terlepas dari siapa yang memicunya — dapat dilihat dan diunduh oleh admin yang berwenang. Kolom <strong>REQUESTED BY</strong> menampilkan siapa yang awalnya men-generate setiap laporan.
                    </div>
                </div>
            </div>
        </div>
