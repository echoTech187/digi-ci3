<div id="module-ug-external-balance-log" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                ...
                <h3 class="hc-step-title">Auditing Balance Snapshots — Step-by-Step</h3>
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                ...
                <h3 class="hc-step-title">Interpreting Discrepancies</h3>
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Issue 3: An aggregator column shows 0 or FETCH_ERROR in today's snapshot</span>
            </div>
            <div class="hc-faq-a">
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                <div class="hc-step-number">1</div>
                <h3 class="hc-step-title">Mengaudit Snapshot Saldo — Langkah-demi-Langkah</h3>
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                <div class="hc-step-number">2</div>
                <h3 class="hc-step-title">Menginterpretasikan Selisih (Discrepancy)</h3>
                <div class="table-responsive shadow-sm mt-3" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                    <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                        <thead style="background: rgba(0,0,0,0.4);">
                            <tr>
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 3: Kolom agregator menampilkan 0 atau FETCH_ERROR di snapshot hari ini</span>
            </div>
            <div class="hc-faq-a">
