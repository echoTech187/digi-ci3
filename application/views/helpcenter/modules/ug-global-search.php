<div id="module-ug-global-search" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-keyboard text-primary mr-2"></i> 1. Architecture &amp; How to Use Global Search</h5>
        ...
        <!-- Section 2: RBAC Integration -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-shield-alt text-success mr-2"></i> 2. Smart Redirection &amp; Permissions</h5>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#gs_faq1_en" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 1: A transaction I know exists isn't showing up
                </a>
                <div id="gs_faq1_en" class="collapse">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#gs_faq2_en" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 2: The search results appear slow or lag significantly
                </a>
                <div id="gs_faq2_en" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#gs_faq3_en" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Issue 3: Clicking a merchant result opens the wrong page
                </a>
                <div id="gs_faq3_en" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <!-- Section 1: Architecture & Workflow -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-keyboard text-primary mr-2"></i> 1. Arsitektur &amp; Cara Menggunakan Global Search</h5>
        ...
        <!-- Section 2: RBAC Integration -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-shield-alt text-success mr-2"></i> 2. Pengalihan Cerdas &amp; Hak Akses</h5>
        ...
        <div class="faq-accordion mb-5">
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#gs_faq1_id" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 1: Transaksi yang saya tahu ada tidak muncul
                </a>
                <div id="gs_faq1_id" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#gs_faq2_id" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 2: Hasil pencarian lambat muncul atau terasa lag
                </a>
                <div id="gs_faq2_id" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
            ...
            <div class="border-0 mb-3 border-bottom pb-2">
                <a href="#gs_faq3_id" data-toggle="collapse" class="d-block text-body text-decoration-none font-weight-bold pb-2">
                    <i class="fas fa-chevron-right mr-2 text-muted" style="font-size:0.8rem;"></i> Masalah 3: Mengklik hasil merchant membuka halaman yang salah
                </a>
                <div id="gs_faq3_id" class="collapse">
                    <div class="text-muted px-4 pb-4 pt-1" style="line-height: 1.7; font-size: 0.9rem;">
