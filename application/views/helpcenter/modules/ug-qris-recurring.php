<div id="module-ug-qris-recurring" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                ...
                <span>Issue 1: How does QRIS Recurring work if the customer has to scan?</span>
            </div>
            <p class="hc-faq-a"><strong>Answer:</strong> QRIS Recurring (Tokenization) requires the customer to authorize a mandate during their very first scan. Future billings will automatically pull funds from their linked e-wallet without the customer needing to scan anything again.</p>
        </div>

        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Issue 2: Which e-wallets support QRIS Recurring?</span>
            </div>
            <p class="hc-faq-a"><strong>Answer:</strong> Currently, only a select few premium e-wallets (like ShopeePay, DANA, or GoPay Premium) support true QRIS tokenization. Standard bank apps typically do not support auto-debit via QRIS yet.</p>
        </div>

        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Issue 3: Why was a recurring deduction rejected by the e-wallet?</span>
            </div>
            <p class="hc-faq-a"><strong>Answer:</strong> This almost always happens if the customer's e-wallet balance is insufficient, or if the customer manually went into their e-wallet app settings and revoked the mandate authorization for the merchant.</p>
        </div>
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 1: Bagaimana QRIS Recurring menagih tanpa scan berulang?</span>
            </div>
            <p class="hc-faq-a"><strong>Jawaban:</strong> QRIS Recurring (Tokenisasi) mengharuskan pelanggan menyetujui mandat pada pemindaian pertama. Penagihan bulan-bulan berikutnya akan langsung menarik dana dari dompet terhubung secara otomatis via API tanpa pelanggan perlu memindai kode QR lagi.</p>
        </div>

        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 2: E-wallet mana saja yang mendukung QRIS Recurring?</span>
            </div>
            <p class="hc-faq-a"><strong>Jawaban:</strong> Saat ini, baru beberapa e-wallet tier atas (seperti ShopeePay, DANA, GoPay Premium) yang menyokong infrastruktur tokenisasi QRIS. Sebagian besar aplikasi Mobile Banking belum mendukung fitur auto-debit QRIS.</p>
        </div>

        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 3: Kenapa penagihan berulang ditolak oleh sistem e-wallet?</span>
            </div>
            <p class="hc-faq-a"><strong>Jawaban:</strong> Kasus ini mayoritas terjadi jika saldo e-wallet nasabah tidak mencukupi untuk dipotong, atau nasabah diam-diam masuk ke pengaturan e-wallet mereka dan mencabut (revoke) izin mandat berlangganan untuk merchant tersebut.</p>
        </div>
