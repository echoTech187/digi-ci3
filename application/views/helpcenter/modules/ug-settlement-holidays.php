<div id="module-ug-settlement-holidays" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <!-- Section 2: Adding a Holiday -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-calendar-plus text-primary mr-2"></i> 2. Managing the Calendar</h5>
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <!-- Section 2: Adding a Holiday -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-calendar-plus text-primary mr-2"></i> 2. Mengelola Kalender</h5>
