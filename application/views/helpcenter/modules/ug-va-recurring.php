<div id="module-ug-va-recurring" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                ...
                <h3 class="hc-step-title">Searching and Filtering Subscriptions</h3>
                ...
                <div class="pl-4 border-left border-success ml-2 mb-4">
                    <ol class="text-muted mb-0">
                        <li class="mb-3"><strong>Quick Search:</strong> Type in the <em>Search by Channel, Merchant, or ID...</em> box to instantly filter the table.</li>
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                ...
                <span>Issue 1: What happens if a recurring billing fails?</span>
            </div>
            <p class="hc-faq-a"><strong>Answer:</strong> The system will automatically log the failure. Depending on the merchant's API configuration, it may attempt to retry the billing on the next cycle, or the subscription mandate will be suspended until manual intervention.</p>
        </div>

        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Issue 2: Can the merchant change the recurring amount mid-cycle?</span>
            </div>
            <p class="hc-faq-a"><strong>Answer:</strong> No, the recurring amount is strictly locked when the initial subscription mandate is created. To change the price, the old subscription must be cancelled and a new one created by the customer.</p>
        </div>

        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Issue 3: Are customers notified before the auto-debit?</span>
            </div>
            <p class="hc-faq-a"><strong>Answer:</strong> Our system acts only as the payment processor/gateway. The merchant's own application is fully responsible for sending reminder emails or SMS to their customers prior to the scheduled billing date.</p>
        </div>
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <div class="row hc-step-row align-items-start mb-4">
            <div class="col-lg-12">
                <div class="hc-step-number">1</div>
                <h3 class="hc-step-title">Mencari dan Memfilter Langganan</h3>
                <p class="text-muted mb-4">Gunakan alat ini untuk memantau siklus langganan aktif dan penagihan terjadwal.</p>

                <div class="pl-4 border-left border-success ml-2 mb-4">
                    <ol class="text-muted mb-0">
                        <li class="mb-3"><strong>Pencarian Cepat:</strong> Ketik di kotak <em>Search by Channel, Merchant, or ID...</em> untuk memfilter tabel secara instan.</li>
        ...
        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 1: Apa yang terjadi jika penagihan berulang gagal?</span>
            </div>
            <p class="hc-faq-a"><strong>Jawaban:</strong> Sistem otomatis mencatat kegagalan. Bergantung pada konfigurasi API merchant, sistem mungkin mencoba menagih ulang pada siklus berikutnya, atau menangguhkan mandat langganan tersebut sampai ada intervensi manual.</p>
        </div>

        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 2: Bisakah merchant mengubah jumlah tagihan di tengah siklus?</span>
            </div>
            <p class="hc-faq-a"><strong>Jawaban:</strong> Tidak, jumlah penagihan dikunci ketat saat mandat langganan awal dibuat. Untuk mengubah harga paket, langganan lama wajib dibatalkan dan yang baru dibuat ulang oleh pelanggan.</p>
        </div>

        <div class="hc-faq-item">
            <div class="hc-faq-q">
                <i class="fas fa-question-circle text-warning"></i> 
                <span>Masalah 3: Apakah pelanggan diberi tahu sebelum auto-debit?</span>
            </div>
            <p class="hc-faq-a"><strong>Jawaban:</strong> Sistem kami hanya bertindak sebagai gateway/pemroses pembayaran. Aplikasi milik merchant bertanggung jawab penuh untuk mengirimkan email pengingat atau SMS peringatan ke nasabah mereka sebelum tanggal penagihan.</p>
        </div>
