    ...
    <div class="ug-module-content">
        ...
        <div class="lang-content lang-en" style="display:block;">
            ...
            <div class="hc-premium-overview mb-4">
                ...
                <p class="mb-0">The <strong>Cashout Providers</strong> module allows you to globally configure which outbound payment channels are available across the system. It controls the underlying disbursement providers (Aggregators/Acquirers) and sets the baseline pricing, limits, and rules for all merchants before merchant-specific mappings are applied.</p>
            </div>
                ...
                <div class="col-lg-5 order-2 order-lg-1">
                    ...
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ol class="hc-step-desc mb-0">
                            ...
                            <li class="mb-2">Select the <strong>Cash-Out Providers</strong> sub-menu to open the global configuration interface.</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ol class="hc-step-desc mb-0">
                            ...
                            <li class="mb-2"><strong>Channel Group:</strong> Filter by macro payment category (e.g., Bank Transfer, Bi-Fast).</li>
            ...
            <div class="row hc-step-row align-items-center mb-5">
                <div class="col-lg-12 order-2 order-xl-1">
                    ...
                    <p class="hc-step-desc mb-3">The main table gives you a comprehensive overview of all global cash-out channels. Here is a breakdown of the key features and data points available:</p>
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ul class="hc-step-desc mb-0 list-unstyled">
                            <li class="mb-3">
                                ...
                                <ul class="mt-2 text-muted" style="list-style-type: circle; padding-left: 35px;">
                                    <li class="mb-1"><strong>Channel ID</strong> (e.g., <code>bifast_bca</code>)</li>
                                    <li class="mb-1"><strong>Channel Group</strong> (e.g., <code>bifast</code>)</li>
                                    <li class="mb-0"><strong>External ID Default</strong> (e.g., <code>quantum</code>)</li>
                                </ul>
                            </li>
                            <li class="mb-3">
            ...
            <div class="row hc-step-row align-items-center mb-5">
                <div class="col-lg-12">
                    ...
                    <p>To register a new channel, first click the <strong>+ New Cash Out Channel</strong> button on the top right of the table. The following field mappings are required to create a new global cash-out configuration:</p>
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ol class="hc-step-desc mb-0">
                            <li class="mb-3"><strong>Channel Identifiers:</strong> Select or input the <strong>Channel ID</strong> (e.g. <code>bifast_bca</code>) to define the specific endpoint, and the <strong>Channel Group</strong> (e.g. <code>bifast</code>) for categorization. <br><em class="text-danger small"><i class="fas fa-exclamation-triangle"></i> Validation: The Channel ID must exactly match the upstream provider's expected payload format.</em></li>
                            ...
                            <li class="mb-3"><strong>External Provider:</strong> Define the <strong>External Default</strong> to link this channel to the actual upstream aggregator (e.g. <code>quantum</code>). This dictates where the disbursement funds are routed.</li>
                            ...
                            <li class="mb-3"><strong>Amount Limits:</strong> Configure the <strong>Amount Min</strong> and <strong>Amount Max</strong> boundaries (e.g., <code>10000</code> to <code>50000000</code>) to protect against invalid payout requests. <br><em class="text-danger small"><i class="fas fa-exclamation-triangle"></i> Validation: The system strictly verifies that Amount Min is not greater than Amount Max.</em></li>
                            <li class="mb-3"><strong>Final Review & Save:</strong> Review your configuration against the guide on the left panel, then click the <strong>Save New Cash Out</strong> button to commit it to the database.</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <ol class="hc-step-desc mb-0">
                            ...
                            <li class="mb-3"><strong>Make Changes:</strong> Update the necessary fields to adapt to new business rules:
                                <ul class="mt-2 text-muted" style="list-style-type: circle; padding-left: 35px;">
                                    ...
                                    <li class="mb-1"><strong>Amount Limits:</strong> Modify the <strong>Amount Min/Max</strong> boundaries to restrict outbound payouts.</li>
                                </ul>
                            ...
                            <li class="mb-3"><strong>Save Updates:</strong> Double-check the modified values, then click <strong>Update Cash Out</strong> to apply the changes immediately to the global configuration.</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-bordered hc-ref-table bg-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>The precise endpoint identifier (e.g., <code>bifast_bca</code>, <code>bifast_mandiri</code>). This must exactly match the upstream provider's expected payload format.</td>
                        </tr>
                        <tr>
                            <td><strong>External Default</strong></td>
                            <td>The designated third-party aggregator or acquiring bank entrusted with processing the disbursement funds (e.g., <code>quantum</code>, <code>paylabs</code>).</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>Establishes the absolute security boundaries for outbound transaction amounts. If a merchant sets their own limits to 0, these global limits will be enforced by default.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="hc-faq-item">
                ...
                <p class="hc-faq-a">The global fee serves as the baseline. It does not automatically overwrite bespoke fee mappings that you have already configured for individual merchants in the External Cash-Out module.</p>
            </div>
        ...
        <div class="lang-content lang-id" style="display:none;">
                ...
                <div class="col-lg-5 order-2 order-lg-1">
                    ...
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ol class="hc-step-desc mb-0">
                            ...
                            <li class="mb-2">Pilih sub-menu <strong>Cash-Out Providers</strong> untuk membuka halaman konfigurasi global.</li>
                        </ol>
                    </div>
                </div>
                <div class="col-lg-7 order-1 order-lg-2 mb-4 mb-lg-0">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ol class="hc-step-desc mb-0">
                            ...
                            <li class="mb-2"><strong>Channel Group:</strong> Filter berdasarkan kategori pembayaran (mis. Bank Transfer, Bi-Fast).</li>
            ...
            <div class="row hc-step-row align-items-center mb-5">
                <div class="col-lg-12 order-2 order-xl-1">
                    ...
                    <p class="hc-step-desc mb-3">Tabel utama memberikan gambaran komprehensif mengenai seluruh *channel* cash-out global. Berikut penjelasan detail dari fitur dan data yang tersedia:</p>
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ul class="hc-step-desc mb-0 list-unstyled">
                            <li class="mb-3">
                                ...
                                <ul class="mt-2 text-muted" style="list-style-type: circle; padding-left: 35px;">
                                    <li class="mb-1"><strong>Channel ID</strong> (contoh: <code>bifast_bca</code>)</li>
                                    <li class="mb-1"><strong>Channel Group</strong> (contoh: <code>bifast</code>)</li>
                                    <li class="mb-0"><strong>External ID Default</strong> (contoh: <code>quantum</code>)</li>
                                </ul>
                            </li>
                            <li class="mb-3">
            ...
            <div class="row hc-step-row align-items-center mb-5">
                <div class="col-lg-12">
                    ...
                    <p>Untuk mendaftarkan channel baru, pertama-tama klik tombol <strong>+ New Cash Out Channel</strong> di sudut kanan atas tabel. Berikut adalah pengaturan yang wajib diisi untuk mendaftarkan channel cash-out baru secara global:</p>
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ol class="hc-step-desc mb-0">
                            <li class="mb-3"><strong>Identitas Channel:</strong> Pilih atau ketik <strong>Channel ID</strong> (misal <code>bifast_bca</code>) untuk menentukan *endpoint* spesifik, dan <strong>Channel Group</strong> (misal <code>bifast</code>) untuk kategorisasi. <br><em class="text-danger small"><i class="fas fa-exclamation-triangle"></i> Validasi: Channel ID harus sama persis dengan format *payload* yang diharapkan oleh provider hulu.</em></li>
                            ...
                            <li class="mb-3"><strong>Provider Eksternal:</strong> Tentukan <strong>External Default</strong> untuk mengaitkan saluran ini dengan aggregator di hulu (misal <code>quantum</code>). Kolom ini menentukan ke mana rute dana penarikan akan diarahkan.</li>
                            ...
                            <li class="mb-3"><strong>Limit Transaksi:</strong> Konfigurasikan batas transaksi <strong>Amount Min</strong> dan <strong>Amount Max</strong> (misal <code>10000</code> hingga <code>50000000</code>) untuk melindungi sistem dari *request* penarikan dana yang tidak wajar. <br><em class="text-danger small"><i class="fas fa-exclamation-triangle"></i> Validasi: Sistem memverifikasi secara ketat bahwa Amount Min tidak boleh lebih besar dari Amount Max.</em></li>
                            <li class="mb-3"><strong>Review & Simpan:</strong> Periksa kembali konfigurasi Anda dengan panduan di panel kiri, lalu klik tombol <strong>Save New Cash Out</strong> untuk menyimpannya ke dalam database.</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="pl-4 border-left border-success ml-2 mt-3">
                        <ol class="hc-step-desc mb-0">
                            ...
                            <li class="mb-3"><strong>Lakukan Perubahan:</strong> Perbarui kolom-kolom berikut sesuai dengan aturan bisnis terbaru:
                                <ul class="mt-2 text-muted" style="list-style-type: circle; padding-left: 35px;">
                                    <li class="mb-1"><strong>Provider Eksternal:</strong> Ubah <strong>External Default</strong> jika ingin mengganti rute aggregator (contoh: dari <code>paylabs</code> ke <code>quantum</code>).</li>
                                    ...
                                    <li class="mb-1"><strong>Limit Transaksi:</strong> Modifikasi batas penarikan <strong>Amount Min/Max</strong> untuk menjaga batas aman pengeluaran dana.</li>
                                </ul>
                            ...
                            <li class="mb-3"><strong>Simpan Perubahan:</strong> Periksa kembali nilai yang diubah, lalu klik <strong>Update Cash Out</strong> untuk menerapkan perubahan secara langsung pada konfigurasi global.</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive mb-5">
                <table class="table table-bordered hc-ref-table bg-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong>Specific Channel ID</strong></td>
                            <td>Pengenal titik akhir presisi (contoh: <code>bifast_bca</code>). ID ini harus sama persis dengan *payload* yang diterima/diminta oleh provider.</td>
                        </tr>
                        <tr>
                            <td><strong>External Default (Provider)</strong></td>
                            <td>*Aggregator* pihak ketiga atau bank *acquirer* definitif yang memproses dana pencairan (contoh: <code>quantum</code>, <code>paylabs</code>).</td>
                        </tr>
                        <tr>
                            <td><strong>Fee Type</strong></td>
            ...
            <div class="hc-faq-item">
                ...
                <p class="hc-faq-a">Nilai biaya global berfungsi sebagai *baseline*. Jika Anda mengubahnya, ia TIDAK otomatis menimpa (overwrite) konfigurasi biaya khusus yang sudah Anda buat per merchant di modul External Cash-Out.</p>
            </div>
