<div id="module-ug-cashout" class="hc-doc-section">
    ...
    <div class="lang-content lang-en" style="display:block;">
        ...
        <div class="mb-5">
            ...
            <p class="text-muted mb-4">Click the three dots (⋮) on any cashout channel row to access these management tools:</p>
            <div class="table-responsive shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                    <thead style="background: rgba(0,0,0,0.4);">
                        <tr>
                    ...
                    <tbody>
                        <tr><td class="p-3 border-0"><strong><i class="fas fa-edit text-info"></i> Edit Channel</strong></td><td class="p-3 border-0">Update the fee values, fee types, or limits for this specific disbursement channel.</td></tr>
                        <tr><td class="p-3 border-0"><strong><i class="fas fa-trash-alt text-danger"></i> Delete Channel</strong></td><td class="p-3 border-0">Permanently remove this channel configuration. The merchant will no longer be able to disburse funds through this specific channel ID.</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-plus-circle text-success mr-2"></i> Adding a New Cash Out Channel</h5>
            <div class="pl-4 border-left border-success ml-2 mb-4">
                <ol class="text-muted mb-0">
                    <li class="mb-3">Click the <strong><i class="fas fa-plus"></i> New Cash Out Channel</strong> button at the top right of the table.</li>
                    ...
                    <li class="mb-3">Optionally configure the minimum and maximum amount limits for disbursements.</li>
        ...
        <div class="mb-5">
            ...
            <div class="pl-4 border-left border-primary ml-2 mb-4">
                <ol class="text-muted mb-0">
                    <li class="mb-3"><strong>Quick Search:</strong> Type in the <em>Search by Channel, Provider, or Fee...</em> box to instantly filter the table.</li>
                ...
                <div class="mb-3">
                    <div class="p-3 rounded border" style="background-color: rgba(22, 163, 74, 0.05); border-color: rgba(22, 163, 74, 0.2) !important;">
                        ...
                        <ul class="small text-muted mb-0 pl-3">
                            <li class="mb-1"><strong>Creation:</strong> <code>Cashout channel mapped successfully.</code></li>
                            <li class="mb-1"><strong>Bulk Add:</strong> <code>Bulk cashout channels added successfully. Skipped X existing channels.</code></li>
                            <li class="mb-1"><strong>Update:</strong> <code>Cashout channel updated successfully.</code></li>
                            <li class="mb-0"><strong>Deletion:</strong> <code>Cashout channel mapping removed.</code></li>
                        </ul>
                    </div>
                </div>
                <div class="mb-1">
    ...
    <div class="lang-content lang-id" style="display:none;">
        ...
        <div class="mb-5">
            ...
            <p class="text-muted mb-4">Klik tiga titik (⋮) pada baris kanal cashout mana pun untuk mengakses alat manajemen ini:</p>
            <div class="table-responsive shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                <table class="table table-borderless table-striped small mb-0" style="background: rgba(255,255,255,0.02);">
                    <thead style="background: rgba(0,0,0,0.4);">
                        <tr>
                    ...
                    <tbody>
                        <tr><td class="p-3 border-0"><strong><i class="fas fa-edit text-info"></i> Edit Channel</strong></td><td class="p-3 border-0">Perbarui nilai biaya, jenis biaya, atau limit untuk kanal pengeluaran dana spesifik ini.</td></tr>
                        <tr><td class="p-3 border-0"><strong><i class="fas fa-trash-alt text-danger"></i> Delete Channel</strong></td><td class="p-3 border-0">Hapus konfigurasi kanal ini secara permanen. Merchant tidak akan lagi bisa melakukan pengeluaran dana melalui ID kanal ini.</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <!-- Step by Step Add Channel -->
        <div class="mb-5">
            <h5 class="font-weight-bold mb-4 d-flex align-items-center"><i class="fas fa-plus-circle text-success mr-2"></i> Menambahkan Kanal Cash Out Baru</h5>
            <div class="pl-4 border-left border-success ml-2 mb-4">
                <ol class="text-muted mb-0">
                    <li class="mb-3">Klik tombol <strong><i class="fas fa-plus"></i> New Cash Out Channel</strong> di kanan atas tabel.</li>
                    ...
                    <li class="mb-3">Secara opsional, konfigurasikan limit jumlah minimum dan maksimum untuk pengeluaran dana.</li>
        ...
        <div class="mb-5">
            ...
            <div class="pl-4 border-left border-primary ml-2 mb-4">
                <ol class="text-muted mb-0">
                    <li class="mb-3"><strong>Pencarian Cepat:</strong> Ketik di kotak <em>Search by Channel, Provider, or Fee...</em> untuk memfilter tabel secara instan.</li>
            ...
            <div class="d-flex flex-column mb-4">
                <div class="mb-3">
                    <div class="p-3 rounded border" style="background-color: rgba(22, 163, 74, 0.05); border-color: rgba(22, 163, 74, 0.2) !important;">
                        ...
                        <ul class="small text-muted mb-0 pl-3">
                            <li class="mb-1"><strong>Pembuatan:</strong> <code>Cashout channel mapped successfully.</code></li>
                            <li class="mb-1"><strong>Penambahan Massal:</strong> <code>Bulk cashout channels added successfully. Skipped X existing channels.</code></li>
                            <li class="mb-1"><strong>Pembaruan:</strong> <code>Cashout channel updated successfully.</code></li>
                            <li class="mb-0"><strong>Penghapusan:</strong> <code>Cashout channel mapping removed.</code></li>
                        </ul>
                    </div>
                </div>
                <div class="mb-1">
