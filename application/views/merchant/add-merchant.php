        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm dt-card">
                ...
                <div class="card-body p-4 pt-0">
                    ...
                    <form class="ajax-form" action="<?= base_url('merchant/manage/register'); ?>" data-redirect="<?= base_url('merchant/manage'); ?>" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="password" name="c_password" class="form-control" autocomplete="new-password" required>
                            </div>
                            <div class="col-md-6 mb-4">
                                <label class="font-weight-bold text-gray-700 small">Confirm Password</label>
                                <input type="password" name="c_confirmPassword" class="form-control" autocomplete="new-password" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <label class="font-weight-bold text-gray-700 small">Callback Transfer</label>
                                <input type="text" name="c_openapiUrlCallbackTransfer" class="form-control" placeholder="https://api.your.com/callback">
                            </div>
                        ...
                        <div class="row pt-2">
                            ...
                            <div class="col-md-4">
                                ...
                                $transfer_checkboxes = [
                                    ...
                                    'c_openapiChannelTransferToBifastQuery'         => 'BI-FAST Query',
                                    'c_openapiChannelTransferToRealtimeOnline'      => 'Realtime Online Transfer',
                                    'c_openapiChannelTransferToRealtimeOnlineQuery' => 'Realtime Online Transfer Query',
                                    'c_openapiChannelBalanceQuery'                  => 'Balance Query',
