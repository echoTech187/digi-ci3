                    ...
                    <div class="d-flex g-0 w-100 flex-column flex-lg-row">
                        ...
                        <div class="col-lg-4 p-4 d-flex flex-column justify-content-between mb-0 bg-dark-subtle">
                            <div>
                                ...
                                <p class="text-muted small mb-4" style="font-size: 12px; line-height: 1.5;">Configure payment channels, fee structures, and transaction limits accurately.</p>
                                ...
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <div class="bg-white p-3 rounded-4 shadow-sm border-0 mb-3">
                                        ...
                                        <p class="text-muted mb-0" style="font-size: 11px; line-height: 1.5;">Choose Fixed, Percentage, or Both to define charges.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
