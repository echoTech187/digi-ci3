<div>
    ...
    <div class="drawer-right" id="instructionDrawer">
        ...
        <div class="drawer-body">
            <p class="drawer-desc">Configure outbound disbursement fees for <strong><?= $merchant_name ?></strong>.</p>
            ...
            <div class="drawer-card">
                ...
                <p class="drawer-card-text">Configure a single specific payout channel with dedicated fee structures.</p>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm dt-card">
        ...
        <div class="table-responsive">
            <table class="table dt-table mb-0 align-middle" id="cashoutFeeTable" style="width: 100%;">
                <thead>
                    <tr>
...
<?php $this->load->view('merchant/partials/modal_setting_cashout_fee'); ?>

<!-- ── Include JavaScript Assets ── -->
<script>
    window.CURRENT_MERCHANT_ID = "<?= $merchant_id ?>";
</script>
<script src="<?= base_url('assets/js/merchant_setting_cashout_fee.js'); ?>"></script>
