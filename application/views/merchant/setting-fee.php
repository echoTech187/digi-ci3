...
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="feeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <form id="feeForm" method="post" action="<?= base_url('merchant/setting-cashin-fee/create'); ?>">
                    ...
                    <div class="d-flex g-0 w-100">
                        ...
                        <div class="col-lg-4 p-4 d-flex flex-column justify-content-between mb-0 bg-dark-subtle" >
                            <div>
                                ...
                                <p class="text-muted small mb-4" style="font-size: 12px; line-height: 1.5;">Follow the instructions below to configure payment channels, fee structures, and transaction limits accurately.</p>
                                ...
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <div class="bg-white p-3 rounded-4 shadow-sm border-0 mb-3">
                                        <h6 class="fw-bold text-dark mb-1 d-flex align-items-center" style="font-size: 12.5px;"><i class="fas fa-calendar-alt text-primary mr-2"></i> 3. Settlement</h6>
                                        <p class="text-muted mb-0" style="font-size: 11px; line-height: 1.5;">Define disbursement duration in days. Enter <code>0</code> for instant realtime settlement (H+0).</p>
                                    </div>
                                    <div class="bg-white p-3 rounded-4 shadow-sm border-0 mb-3">
                                        <h6 class="fw-bold text-dark mb-1 d-flex align-items-center" style="font-size: 12.5px;"><i class="fas fa-shield-alt text-primary mr-2"></i> 4. Limits & Status</h6>
...
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="bulkModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <form method="post" action="<?= base_url('merchant/setting-cashin-fee/bulk-create/' . $merchant_id); ?>">
                <div class="modal-body p-0 bg-light">
                    <div class="d-flex g-0 w-100">
                        <!-- Left Information Sidebar -->
                        <div class="col-lg-4 p-4 d-flex flex-column justify-content-between mb-0 bg-dark-subtle" >
...
$(document).ready(function() {
                        ...
                        return `
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>
                                        <button class="dropdown-item rounded-2 py-2 text-danger delete-fee-btn" data-href="<?= base_url('merchant/setting-cashin-fee/delete/'. $merchant_id) ?>/${row.id}">
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $('#c_settlementInterval').val(Math.floor(parseFloat(d.settlement)));
    ...
    $('.add-btn').click(function() {
        ...
        $('#feeForm').attr('action', `<?= base_url('merchant/setting-cashin-fee/create'); ?>`);
        $('#feeForm')[0].reset();
    ...
    $(document).on('click', '.delete-fee-btn', function(e) {
        ...
        Swal.fire({
            ...
            text: 'Are you sure you want to delete this cashin fee configuration? This action cannot be undone.',
            icon: 'warning',
