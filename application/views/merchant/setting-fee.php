    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header modal-header-primary border-0 py-3 px-4">
                <h5 class="modal-title fw-bold text-white" id="exampleModalLabel"><i class="fas fa-cog me-2"></i>Add Cashin Fee Setting</h5>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border-0 shadow-none bg-white p-3 rounded-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select border-1" id="c_cashinChannelGroup" required name="c_cashinChannelGroup">
                                ...
                                <div class="mb-0">
                                    ...
                                    <select class="form-select border-1" id="ref_cashinChannelId" required name="ref_cashinChannelId" disabled>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text border-1 bg-light small">Days</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
<div class="modal fade" id="bulkModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header modal-header-primary border-0 py-3 px-4">
                <h5 class="modal-title fw-bold text-white"><i class="fas fa-layer-group me-2"></i>Bulk Add Cashin Fees</h5>
                <button type="button" class="close text-white outline-none" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border-0 shadow-none bg-white p-3 rounded-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select border-1" required name="c_cashinChannelGroup">
                                        <option value="" selected disabled>Select group</option>
                                        <?php foreach ($channel_groups as $chg): ?>
                                            <option value="<?= $chg->c_channelGroup ?>"><?= $chg->c_channelGroup ?></option>
                                        <?php endforeach; ?>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-btn', function() {
        const d = $(this).data();
        $('#exampleModalLabel').html('<i class="fas fa-edit me-2"></i>Edit Cashin Fee Configuration');
        $('#feeForm').attr('action', `<?= base_url('admin/editSettingCashinFee/' . $merchant_id) ?>/${d.id}`);
        
        $('#c_cashinChannelGroup').val(d.group);
    ...
    $('.add-btn').click(function() {
        $('#exampleModalLabel').html('<i class="fas fa-plus me-2"></i>Add New Cashin Fee');
