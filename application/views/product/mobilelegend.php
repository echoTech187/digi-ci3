...
<div>
    ...
    <div class="dt-page-header">
        <div>
            ...
            <p class="dt-page-subtitle">Manage Mobile Legend Diamonds and denominations.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm dt-card">
        <!-- ── Toolbar ── -->
        <form id="mobilelegend_form" onsubmit="return false;">
                    ...
                    <div class="d-flex g-0 w-100 flex-column flex-lg-row">
                        <div class="col-lg-4 p-4 d-flex flex-column mb-0" style="background:#202328;border-right:1px solid rgba(255,255,255,0.05);color:#fff;">
                            <div class="d-flex align-items-center mb-3">
                                <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center mr-3" style="width:40px;height:40px;flex-shrink:0;"><i class="fas fa-dragon fa-lg"></i></div>
                                <h6 class="fw-bold text-primary mb-0" style="font-size:15px;">Mobile Legends Guide</h6>
                            </div>
                            <p class="text-muted small mb-3" style="font-size:12px;line-height:1.5;">Register Mobile Legends diamond denominations for player top-ups.</p>
                            <div class="p-3 mb-3" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:12px;">
                                <h6 class="fw-bold text-white mb-1 d-flex align-items-center" style="font-size:12px;"><i class="fas fa-gem text-warning mr-2"></i> 1. Diamond Pack</h6>
                                <p class="text-muted mb-0" style="font-size:11px;line-height:1.4;">Label clearly e.g. 'MLBB 86 Diamonds' so players identify the pack instantly.</p>
                            </div>
                            <div class="p-3 mb-3" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:12px;">
                                ...
                                <p class="text-muted mb-0" style="font-size:11px;line-height:1.4;">Price must cover Moonton supplier cost and include target margin.</p>
                            </div>
                        </div>
                        <div class="col-lg-8 p-4 bg-light">
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="channelgroup2" value="diamond_mlbb">
                                <input type="hidden" name="name" value="mobilelegend">
                            </div>
                            <div class="mb-3">
            ...
            <form id="editProductForm">
                <div class="modal-body p-0 bg-light">
                    <div class="d-flex g-0 w-100 flex-column flex-lg-row">
                        ...
                        <div class="col-lg-8 p-4 bg-light">
                            <input type="hidden" name="view_name" value="mobilelegend">
...
$(document).ready(function() {
    ...
    window.productTable = initServerDataTable('#productTable', "<?= base_url('product/games/mobile-legend') ?>", [
        { data: 'no' },
        { data: 'c_caption' },
        { data: 'c_description' },
        { 
        ...
        "ajax": {
            "url": "<?= base_url('product/games/mobile-legend') ?>",
            "type": "POST",
            "data": function (d) {
