...
<div>
    ...
    <div class="dt-page-header">
        <div>
            ...
            <p class="dt-page-subtitle">Manage PLN Token products and denominations.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm dt-card">
        <!-- ── Toolbar ── -->
        <form id="token_listrik_form" onsubmit="return false;">
            <div class="dt-toolbar">
                ...
                <div class="dt-toolbar-actions">
                    <button type="button" class="btn-dt-chip-action btn-dt-action-success border-0" data-toggle="modal" data-target="#exampleModal">
                        <i class="fas fa-plus"></i> <span class="d-none d-md-block">Add Token</span>
                    </button>
                </div>
            </div>
        </form>
            ...
            <div class="modal-header modal-header-primary border-0 mh-premium">
                <div class="d-flex align-items-center">
                    ...
                    <div class="mh-title-wrap">
                        <h6 class="mh-title" id="exampleModalLabel">ADD TOKEN</h6>
                    ...
                    <div class="d-flex g-0 w-100 flex-column flex-lg-row">
                        <div class="col-lg-4 p-4 d-flex flex-column mb-0" style="background:#202328;border-right:1px solid rgba(255,255,255,0.05);color:#fff;">
                            <div class="d-flex align-items-center mb-3">
                                <div class="bg-warning text-dark rounded-circle d-flex align-items-center justify-content-center mr-3" style="width:40px;height:40px;flex-shrink:0;"><i class="fas fa-bolt fa-lg"></i></div>
                                <h6 class="fw-bold text-warning mb-0" style="font-size:15px;">Token Guide</h6>
                            </div>
                            <p class="text-muted small mb-3" style="font-size:12px;line-height:1.5;">Register a new prepaid electricity token denomination.</p>
                            <div class="p-3 mb-3" style="border-radius:12px;">
                                <h6 class="fw-bold text-white mb-1 d-flex align-items-center" style="font-size:12px;"><i class="fas fa-plug text-warning mr-2"></i> PLN Integration</h6>
                                <p class="text-muted mb-0" style="font-size:11px;line-height:1.4;">Token denominations are linked to PLN's prepaid system. Ensure accuracy in pricing to avoid transaction mismatches.</p>
                            </div>
                        </div>
                        <div class="col-lg-8 p-4 bg-light mb-0">
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="channelgroup2" value="token_pln">
                                <input type="hidden" name="name" value="token_listrik">
                            </div>
                            <div class="mb-3">
                ...
                <div class="modal-body p-0 bg-light">
                    <div class="d-flex g-0 w-100 flex-column flex-lg-row">
                        <div class="col-lg-4 p-4 d-flex flex-column mb-0">
                            ...
                            <p class="text-muted small mb-3" style="font-size:12px;line-height:1.5;">Update electricity token details. Price changes apply immediately to all merchant catalogues.</p>
                            <div class="p-3 mb-3" style="border-radius:12px;">
                        ...
                        <div class="col-lg-8 p-4 bg-light mb-0">
                            ...
                            <input type="hidden" name="view_name" value="token_listrik">
                            ...
                            <div class="mb-3">
                                <label class="form-label small fw-bold text-muted">Description</label>
                                <textarea class="form-control border-1" id="edit_description" name="description" rows="3" ></textarea>
                            </div>
                            <div class="mb-3">
...
$(document).ready(function() {
    ...
    window.productTable = initServerDataTable('#productTable', "<?= base_url('product/token-listrik') ?>", [
        { data: 'no' },
        { data: 'c_caption' },
        { data: 'c_description' },
        { 
        ...
        "ajax": {
            "url": "<?= base_url('product/token-listrik') ?>",
            "type": "POST",
            "data": function (d) {
