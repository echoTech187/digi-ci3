...
<div class="container-fluid pb-4">
    ...
    <div class="dt-page-header">
        <div>
            ...
            <p class="dt-page-subtitle">Manage GoPay top-up products, denominations, and pricing.</p>
        </div>
    </div>
        ...
        <div class="dt-toolbar">
            ...
            <div class="dt-toolbar-filters">
                ...
                <button type="button" class="btn-dt-chip-action btn-dt-action-success border-0" data-toggle="modal" data-target="#exampleModal">
                    <i class="fas fa-plus"></i> <span class="d-none d-md-block">Top Up GoPay</span>
                </button>
            </div>
        </div>
                    ...
                    <div class="modal-content border-0 shadow-sm">
                        <div class="modal-header modal-header-primary border-0 py-3">
                            <h5 class="modal-title font-weight-bold text-white" id="exampleModalLabel">
                                <i class="fas fa-plus-circle mr-2"></i>Top Up GoPay
                            </h5>
                            ...
                            <form method="post" action="<?php echo base_url('admin/createProduk'); ?>">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="hidden" class="form-control" id="caption" name ="channelgroup2" value= "topup_gopay">
                                        <input type="hidden" class="form-control" id="caption" name ="name" value= "topupgopay">
                                    </div>
                                </div>
                                <div class="form-group row">
...
$(document).ready(function() {
    var table = initServerDataTable('#productTable', "<?= base_url('admin/topupgopay') ?>", [
        { data: 'no' },
        { data: 'c_caption' },
        { data: 'c_description' },
        { data: 'c_fee' },
