...
<div class="dt-page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="dt-page-subtitle mb-0">Detailed audit trail and technical parameters for the Virtual Account transaction.</p>
    </div>
    ...
    <div class="modal-header modal-header-primary border-0 py-3 mh-premium">
        <div class="d-flex align-items-center">
            ...
            <div class="mh-title-wrap">
                <h6 class="mh-title">VA TRANSACTION INFO</h6>
