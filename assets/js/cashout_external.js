/**
 * Cashout External Merchant Channel Management
 */
$(document).ready(function() {
    ...
    const listUrl = window.BASE_URL + 'external/cashout/list';
    const editUrl = window.BASE_URL + 'external/cashout/edit/';
    const deleteUrl = window.BASE_URL + 'external/cashout/delete/';
